...
PublicInfoKey CanonicalSuitAbstraction::GetPublicKey(const GameState& state) const {
  PublicInfoKey key = 0;
...
PrivateInfoKey CanonicalSuitAbstraction::GetPrivateKey(const GameState &state,
